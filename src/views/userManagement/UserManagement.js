...
const UserManagement = () => {
  ...
  const fetchUsers = async (searchUser) => {
    try {
      const response = await axios.post("https://www.taxiadmin.hunt30.com/api/vendor/getUser", { search: searchUser });
  ...
  const handleDelete = async (id) => {
    try {
      await axios.delete(`https://www.taxiadmin.hunt30.com/api/vendor/deleteUser/${id}`);
